...
window.fill((0, 0, 0))
window.blit(robot, (70, 100))
window.blit(robot, (70+width, 100))
window.blit(robot, (70+width+width, 100))
window.blit(robot, (70+width+width+width,100))
window.blit(robot, (70+width+width+width+width,100))
window.blit(robot, (70+width+width+width+width+width,100))
window.blit(robot, (70+width+width+width+width+width+width,100))
window.blit(robot, (70+width+width+width+width+width+width+width,100))
window.blit(robot, (70+width+width+width+width+width+width+width+width,100))
window.blit(robot, (70+width+width+width+width+width+width+width+width+width,100))
pygame.display.flip()
